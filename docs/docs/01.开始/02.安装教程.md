...
services:
  nas-tools:
    ...
    environment: 
     ...
     #- REPO_URL=https://ghproxy.com/https://github.com/Media Saber/nas-tools.git  # 当你访问github网络很差时，可以考虑解释本行注释
    restart: always
    network_mode: bridge
    hostname: nas-tools
...
https://github.com/Media Saber/nas-tools/releases
...
git clone -b master https://github.com/Media Saber/nas-tools --recurse-submodule 
...
- 正常情况下，如果设置了`NASTOOL_AUTO_UPDATE=true`，重启容器即可自动更新Media Saber程序。
...
```shell
-e REPO_URL="https://ghproxy.com/https://github.com/Media Saber/nas-tools.git" 
```
<br>
